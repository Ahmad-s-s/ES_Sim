...
public class Icons {
    ...
    public static ImageIcon privacy = new ImageIcon("Var/icons8-privacy-64.png");
    public static ImageIcon list = new ImageIcon("Var/icons8-list-64.png");
    public static ImageIcon delete = new ImageIcon("Var/delete-forever.png");
